...
export class BookService extends BaseService {
  ...
  static readonly FindBooksPath = '/books';
   ...
   */
  findBooks$Response(params?: FindBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<BookResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  findBooks(params?: FindBooks$Params, context?: HttpContext): Observable<BookResponse> {
  ...
  static readonly FindAllBooksPath = '/books/{book-id}';
